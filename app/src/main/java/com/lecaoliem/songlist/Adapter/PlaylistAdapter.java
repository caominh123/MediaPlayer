...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ViewHolder> {
    ...
    public PlaylistAdapter(Context context, List<Playlist> playlists, SQLiteDatabase database) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        //Picasso.with(context).load(playlist.getMidPlayList()).into(viewHolder.imgHinhPlaylist);//gethinh
        viewHolder.txtPlaylistName.setText(playlist.getmPlaylistName());
        viewHolder.txtSongNumber.setText(getSongNumber(playlist.getMidPlayList())+" songs");
        viewHolder.imgHinhPlaylist.setImageResource(R.drawable.playlist);
        viewHolder.imgMenuPlaylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(context,viewHolder.imgMenuPlaylist);
    ...
    public   class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            super(view);
            txtPlaylistName = (TextView) view.findViewById(R.id.textviewTenPlaylist);
            txtSongNumber = (TextView) view.findViewById(R.id.textviewNumberSong);
            imgHinhPlaylist = (ImageView) view.findViewById(R.id.imageviewHinhPlaylist);
            imgMenuPlaylist = (ImageView)view.findViewById(R.id.imageviewMenuPlaylist) ;
        }
    }
